...
<html lang="en">
  ...
  <div id="container">
    ...
    <div id="slideshow_container">
    	...
    	<h1>Vegetarian-friendly Food &amp; Beverages</h1>
        ...
        <div id="button_container">
              <!-- Back button -->
              <button onclick="increment(appleimg, 0)">Back</button>
              <!-- Next Button -->
    ...
    <div id="maps">
      ...
      <!--Media citation is included in veganmap.php-->
    </div>
    ...
    <a class="anchor" id="anchor_groups"></a>
     ...
     <div id = "groups_chart">
      ...
      <!--Media citation is included in groups.php-->
     </div>
        
  </div>

  <footer>
      <p>Team Red Green Apple Final Project</p>
  </footer>
